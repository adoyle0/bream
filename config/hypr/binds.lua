...
-- hl.bind(Mod .. " + SHIFT + F", togglefloating)
...
-- hl.bind(Mod .. " + J", layoutmsg, cyclenext)
-- hl.bind(Mod .. " + K", layoutmsg, cycleprev)
-- hl.bind(Mod .. " + L", movefocus, r)
-- hl.bind(Mod .. " + Space", layoutmsg, focusmaster)
--
-- hl.bind(Mod SHIFT, H, movewindow, mon:-1)
-- hl.bind(Mod SHIFT, J, layoutmsg, swapnext)
-- hl.bind(Mod SHIFT, K, layoutmsg, swapprev)
-- hl.bind(Mod SHIFT, L, movewindow, mon:+1)
-- hl.bind(Mod SHIFT, Space, layoutmsg, swapwithmaster)
